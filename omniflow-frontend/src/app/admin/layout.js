    ...
    <div className="dashboard-layout">
      ...
      <aside className="dashboard-sidebar" aria-label="Admin Navigation">
        <div className="dashboard-sidebar__header">
          <div className="logo-placeholder" aria-hidden="true" style={{ backgroundColor: 'var(--color-accent)' }} />
          ...
          <div className="user-profile">
            ...
            <div className="user-info">
              <p className="user-name" style={{ fontWeight: 700 }}>
                {user.name} <span style={{ fontSize: '0.7rem', background: 'var(--color-accent)', color: '#fff', padding: '2px 6px', borderRadius: '4px', marginLeft: '4px' }}>ADMIN</span>
              </p>
